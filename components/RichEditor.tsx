...
export default function RichEditor({ content, onChange }: RichEditorProps) {
  ...
  return (
    <div style={{ border: '1px solid var(--border)', borderRadius: '8px', overflow: 'hidden' }}>
      ...
      <EditorContent
        editor={editor}
        style={{ minHeight: '60vh', padding: '20px 24px', background: 'var(--bg-2)' }}
      />

      <style>{`
        .ProseMirror { outline: none; font-size: 15px; line-height: 1.7; color: var(--text); }
        .ProseMirror h1 { font-size: 24px; font-weight: 600; margin: 24px 0 12px; }
        .ProseMirror h2 { font-size: 20px; font-weight: 600; margin: 20px 0 10px; border-bottom: 1px solid var(--border); padding-bottom: 6px; }
        .ProseMirror h3 { font-size: 16px; font-weight: 600; margin: 16px 0 8px; }
        ...
        .ProseMirror blockquote { border-left: 3px solid var(--accent); padding-left: 14px; color: var(--text-muted); margin: 12px 0; }
